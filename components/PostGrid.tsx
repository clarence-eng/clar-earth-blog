          ...
          {FILTERS.map(({ key, label }) => {
            ...
            return (
              <button
                ...
                className={`font-jost flex-shrink-0 flex items-center gap-1.5 px-4 py-2.5 sm:py-1.5 rounded-full text-[11px] sm:text-[10px] tracking-[0.2em] uppercase transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--forest)] focus-visible:ring-offset-2 ${
                  isActive
