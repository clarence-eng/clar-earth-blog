...
export default function FeaturedPoem({ post }: { post: PostMeta }) {
  ...
  return (
    <section aria-label="Featured work" className="max-w-6xl mx-auto px-8 pt-12 pb-0" data-mood={Array.isArray(post.mood) ? post.mood[0] : post.mood} data-ladybug={post.ladybugColor ?? undefined}>
